local upgrades = {
	{name="Opanowanie oddechu", description="Twój celownik przestanie się poruszać", id="breath", icon="breath", price=50},
	{name="Wytrzymałość", description="Stajesz się bardziej odporny na obrażenia zadawane przez zwierzęta", id="damage", icon="strong", price=100},
	{name="Strój Ghillie", description="Zmniejsza ryzyko wykrycia przez zwierzęta", id="stealth", icon="eye", price=200},
	{name="Shotgun", description="Odblokowywujesz nową broń - shotgun", id="shotgun", icon="shotgun", price=300},
	{name="Termowizor", description="Otrzymujesz termowizor, który wskaże tobie ciepło wydzielane przez zwierzęta", id="infrared", icon="termo", price=100},
}
...
function showUpgradesGUI()
	...
	if playerUpgrades["hunter"] then 
		for k, v in ipairs(playerUpgrades["hunter"].upgrades) do 
		...
		points = playerUpgrades["hunter"].points
	else 
		points = 0
	end 
	...
	textures.breath_icon = dxCreateTexture("images/upgrades_breath_icon.png")
	textures.eye_icon = dxCreateTexture("images/upgrades_eye_icon.png")
	textures.strong_icon = dxCreateTexture("images/upgrades_strong_icon.png")
	textures.shotgun_icon = dxCreateTexture("images/upgrades_shotgun_icon.png")
	textures.termo_icon = dxCreateTexture("images/upgrades_termo_icon.png")
	...
	textures.scrollbar_point = dxCreateTexture("images/gui_scrollbar_point.png")
	textures.scrollbar = dxCreateTexture("images/gui_scrollbar.png")
